    ...
    <DocsLayout>
      <div className="space-y-8">
        ...
        <div className="space-y-2">
          <h1 className="text-4xl font-bold tracking-tight">Vite</h1>
        ...
        <div className="relative pl-8 before:absolute before:left-3 before:top-2 before:bottom-0 before:w-px before:bg-neutral-800">
          ...
          <div className="space-y-4">
            ...
            <p>
              ...
              command to create a new Vite project or to setup an existing one:
            </p>
              ...
              <Tabs defaultValue="pnpm" className="w-full">
                ...
                <div className="p-4 bg-black">
                  ...
                  <TabsContent value="npm" className="mt-0">
                    <pre className="text-sm font-mono">
                      npx shadcn-vite@latest init
                    </pre>
                  </TabsContent>
                  <TabsContent value="yarn" className="mt-0">
                    <pre className="text-sm font-mono">
                      yarn dlx shadcn-vite@latest init
                    </pre>
                  </TabsContent>
                  <TabsContent value="bun" className="mt-0">
                    <pre className="text-sm font-mono">
                      bunx shadcn-vite@latest init
                    </pre>
                  </TabsContent>
                </div>
              </Tabs>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg border border-neutral-800 bg-black p-4">
              <pre className="text-sm font-mono text-neutral-400">
                ...
                CSS file? <span className="text-white">› src/index.css</span>
            ...
            <div className="rounded-lg border border-neutral-800 overflow-hidden">
              <Tabs defaultValue="pnpm" className="w-full">
                ...
                <div className="p-4 bg-black">
                  ...
                  <TabsContent value="npm" className="mt-0">
                    <pre className="text-sm font-mono">
                      npx shadcn-vite@latest add button
                    </pre>
                  </TabsContent>
                  <TabsContent value="yarn" className="mt-0">
                    <pre className="text-sm font-mono">
                      yarn dlx shadcn-vite@latest add button
                    </pre>
                  </TabsContent>
                  <TabsContent value="bun" className="mt-0">
                    <pre className="text-sm font-mono">
                      bunx shadcn-vite@latest add button
                    </pre>
                  </TabsContent>
                </div>
              </Tabs>
