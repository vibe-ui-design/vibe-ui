      ...
      <div className="space-y-8">
        ...
        <div className="relative pl-8 before:absolute before:left-3 before:top-2 before:bottom-0 before:w-px before:bg-neutral-800">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg border border-neutral-800 overflow-hidden mt-4">
              <Tabs defaultValue="pnpm" className="w-full">
                <div className="border-b border-neutral-800 px-4">
                  <TabsList className="bg-transparent border-0 p-0 h-12 gap-4">
                    <TabsTrigger
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg border border-neutral-800 bg-black p-4">
              <pre className="text-sm font-mono text-neutral-400">
                ...
                CSS file? <span className="text-white">› app/globals.css</span>
                ...
                <span className="text-neutral-500">8</span> Are you using React
                Server Components? <span className="text-white">› yes</span>
              </pre>
            </div>
          </div>
        </div>
        ...
        <div className="relative pl-8 before:absolute before:left-3 before:top-2 before:bottom-0 before:w-px before:bg-neutral-800">
          ...
          <div className="space-y-4">
            ...
            <p>You can add multiple components at once:</p>
            ...
            <div className="rounded-lg border border-neutral-800 overflow-hidden">
              <Tabs defaultValue="pnpm" className="w-full">
                ...
                <div className="p-4 bg-black">
                  ...
                  <TabsContent value="yarn" className="mt-0">
                    <pre className="text-sm font-mono">
                      yarn dlx shadcn@latest add button card avatar
                    </pre>
                  </TabsContent>
                  <TabsContent value="bun" className="mt-0">
                    <pre className="text-sm font-mono">
                      bunx shadcn@latest add button card avatar
                    </pre>
                  </TabsContent>
                </div>
              </Tabs>
