    ...
    <DocsLayout>
      <div className="space-y-8">
        ...
        <div className="space-y-2">
          <h1 className="text-4xl font-bold tracking-tight">Astro</h1>
        ...
        <div className="relative pl-8 before:absolute before:left-3 before:top-2 before:bottom-0 before:w-px before:bg-neutral-800">
          ...
          <div className="space-y-4">
            ...
            <p>
              ...
              command to create a new Astro project or to setup an existing one:
            </p>
                ...
                <div className="p-4 bg-black">
                  <TabsContent value="pnpm" className="mt-0">
                    <pre className="text-sm font-mono">
                      pnpm dlx shadcn-astro@latest init
                    </pre>
                  </TabsContent>
                  <TabsContent value="npm" className="mt-0">
                    <pre className="text-sm font-mono">
                      npx shadcn-astro@latest init
                    </pre>
                  </TabsContent>
                  <TabsContent value="yarn" className="mt-0">
                    <pre className="text-sm font-mono">
                      yarn dlx shadcn-astro@latest init
                    </pre>
                  </TabsContent>
                  <TabsContent value="bun" className="mt-0">
                    <pre className="text-sm font-mono">
                      bunx shadcn-astro@latest init
                    </pre>
                  </TabsContent>
                </div>
              </Tabs>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg border border-neutral-800 bg-black p-4">
              <pre className="text-sm font-mono text-neutral-400">
                ...
                CSS file?{' '}
                <span className="text-white">› src/styles/globals.css</span>
                ...
                <span className="text-white">› tailwind.config.mjs</span>
                ...
                alias for utils?{' '}
                <span className="text-white">› @acme/ui/lib/utils</span>
              </pre>
            </div>
          </div>
        </div>
            ...
            <div className="rounded-lg border border-neutral-800 overflow-hidden">
              <Tabs defaultValue="pnpm" className="w-full">
                ...
                <div className="p-4 bg-black">
                  <TabsContent value="pnpm" className="mt-0">
                    <pre className="text-sm font-mono">
                      pnpm dlx shadcn-astro@latest add button
                    </pre>
                  </TabsContent>
                  <TabsContent value="npm" className="mt-0">
                    <pre className="text-sm font-mono">
                      npx shadcn-astro@latest add button
                    </pre>
                  </TabsContent>
                  <TabsContent value="yarn" className="mt-0">
                    <pre className="text-sm font-mono">
                      yarn dlx shadcn-astro@latest add button
                    </pre>
                  </TabsContent>
                  <TabsContent value="bun" className="mt-0">
                    <pre className="text-sm font-mono">
                      bunx shadcn-astro@latest add button
                    </pre>
                  </TabsContent>
                </div>
              </Tabs>
